...
## Neural field model with calcium-dependent plasticity interpret TFUS and TMS mechanisms
...
## Model predicts plasticity effects in response to different TFUS parameters
