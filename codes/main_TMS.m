...
%params.amp = 30.45; % Kevin's paper

%params.amp = 45; % 25 Dec 30

% params.amp = 40; % 26 Jan 2
...
params.onset = 50; params.Duration = 80; params.on = 2; params.off = 0;
