...
pct_change_nu_ee_vec_py = np.zeros(len(PRF_vec))

for ii in range(0,len(PRF_vec)):
    ...
    params.Duration = 80  # total stimulation time [s]
    
    # ---- Continuous sinusoidal pulse-train config ----
    params.stim.cont = SimpleNamespace()
    params.stim.cont.prf_hz = PRF_vec[ii] # 5
