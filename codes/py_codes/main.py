...
from tms import TMS
from wnoise_func import white_stim
...
params.ltp = 2.3e-2 # Fung 2013 LTD and LTP values
params.ltd = 2.0e-2 
...
# --- TMS (directly impact pop 1 (cortical excitatory)) ---
# Fixed values
my_tms_amp_scale = 0.29    
params.TMS_scale_x = 1.0
params.nu_x   = 0.008222    # Kevin
params.width  = 0.5e-3
params.freq   = 50.0
params.onset  = 150.0
params.Duration = 200.0
params.on     = 2.0
params.off    = 8.0
...
# Protocol A
# t_3_5_scale = 105 
# params.amp = my_tms_amp_scale*t_3_5_scale

# Protocol B
# t_2_5_scale = 136.5
# params.amp = my_tms_amp_scale*t_2_5_scale

# Protocol C
# t_3_3_scale = 147
# params.amp = my_tms_amp_scale*t_3_3_scale

# Protocol D
# t_3_7_scale = 81
# params.amp = my_tms_amp_scale*t_3_7_scale

# Protocol E
t_5_5_scale = 75.6
params.amp = my_tms_amp_scale*t_5_5_scale

# Vary these associated bursts and Inter-Burst Frequencies
# params.bursts = 3
# params.bursts = 2
params.bursts = 5

params.oscillation_freq = 5.0
# params.oscillation_freq = 3.0
# params.oscillation_freq = 7.0
...
for step in range(1, nsteps_warm + 1):
    ...
    if params.noise.enabled:
        Q_noise_new = white_stim(params)   # Noise source
    else:
        Q_noise_new = 0.0
...
for step in range(1, nsteps + 1):
    ...
    phi_x    = TMS(abs_step, params)        # Absolute-time TMS call

    if params.noise.enabled:
        Q_noise_new = white_stim(params)    # same generator, but we now filter it
    else:
        Q_noise_new = 0.0
...
###### Uncomment and comment accordingly for required protocol!
row = {
    # "Protocol": "3x5",
    # "Protocol": "2x5",
    # "Protocol": "3x3",
    ...
    "IBF": float(params.oscillation_freq),
...
# ================== Write Excel =================================
df = pd.DataFrame([row])
# df.to_excel("nu_ee_3x5.xlsx", index=False)
# print("Saved: nu_ee_3x5.xlsx")
# df.to_excel("nu_ee_2x5.xlsx", index=False)
# print("Saved: nu_ee_2x5.xlsx")
# df.to_excel("nu_ee_3x3.xlsx", index=False)
# print("Saved: nu_ee_3x3.xlsx")
# df.to_excel("nu_ee_3x7.xlsx", index=False)
# print("Saved: nu_ee_3x7.xlsx")
#df.to_excel("nu_ee_5x5.xlsx", index=False)
#print("Saved: nu_ee_5x5.xlsx")
# ================================================================

# ================== EXPORT V_e (ALL TIME STEPS) TO EXCEL ==================
#import pandas as pd
...
###### Uncomment exactly one filename matching your protocol ######
# fname = "V_e_3x5_timeseries.xlsx"
# fname = "V_e_2x5_timeseries.xlsx"
# fname = "V_e_3x3_timeseries.xlsx"
# fname = "V_e_3x7_timeseries.xlsx"
#fname = "V_e_5x5_timeseries.xlsx"
