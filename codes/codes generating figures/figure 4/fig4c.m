...
% Initialize:
% PRF_vec = [1,2,5,10,15,20,25,30,35,40,45,50];
% pct_change_nu_ee_vec = zeros(1,length(PRF_vec));

function pct_change_nu_ee_vec = fig4c(PRF_vec)

for jj = 1:length(PRF_vec)
    %% --- Grid and time ---
    ...
    params.stim.cont.prf_hz           = PRF_vec(jj);       % PRF: 5 Hz
    duty_cycle = 0.1;
