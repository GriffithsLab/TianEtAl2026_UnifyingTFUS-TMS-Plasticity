...
% pct_change_nu_ee_vec = zeros(1,length(amp_vec));

function pct_change_nu_ee_vec = fig4a(amp_vec)

for jj = 1:length(amp_vec)
    %% --- Grid and time ---
    ...
    params.stim.cont.mean             = amp_vec(jj);   % cTBS(3,5) with pulse_width=0.5ms  
