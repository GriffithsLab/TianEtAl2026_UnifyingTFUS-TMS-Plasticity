...
function pct_change_nu_ee_vec = fig2b_iTB_TMS(duration_vec)
...
for jj = 1:length(duration_vec)
    ...
    params.onset = 50; params.Duration = duration_vec(jj); params.on = 2; params.off = 8;
   ...
   % V_e   = plot_results(Yout, Qout, tplot, params, 1);
    ...
    nu_ee = plot_results_j_to_i(Yout, Qout, tplot, params,1,1); 
